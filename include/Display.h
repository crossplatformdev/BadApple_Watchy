...
class WatchyDisplay : public GxEPD2_EPD
{
  public:
    ...
    static const uint16_t power_on_time = 120; // ms, e.g. 95583us
    static const uint16_t power_off_time = 160; // ms, e.g. 140621us
    static const uint16_t full_refresh_time = 2600; // ms, e.g. 2509602us
    static const uint16_t partial_refresh_time = 555; // ms, e.g. 457282us
    // constructor
    WatchyDisplay();
    void initWatchy();
    ...
    static constexpr bool reduceBoosterTime = false; // Saves ~200ms
  private:
